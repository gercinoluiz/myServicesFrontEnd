...
export default function LandScape() {
  ...
  const locationsCards = locations.map((location, index) => {
    return (
      <a key={index} style={{ textDecoration: 'none' }} rel="noopener noreferrer" href={`https://www.google.com/maps/dir/?api=1&origin=Google+Pyrmont+NSW&destination=${location.address.latitude}, ${location.address.longitude}`}>
