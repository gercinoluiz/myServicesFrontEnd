...
export default function LandScape() {
  ...
  const locationsCards = locations.map((location, index) => {
    return (
      <a key={index} style={{ textDecoration: 'none' }} href={`noopener noreferrer https://www.google.com/maps/dir/?api=1&origin=Google+Pyrmont+NSW&destination=${location.address.latitude}, ${location.address.longitude}`}>
